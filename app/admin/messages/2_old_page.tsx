      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500">
            View recent WhatsApp messages across all tenants. Use the search box
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-56 rounded-full border border-zinc-200 px-3 py-1.5 text-xs outline-none placeholder:text-zinc-400 focus:border-zinc-400"
          />
        </div>
      </div>
