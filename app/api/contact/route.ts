...
export async function POST(req: NextRequest) {
  try {
    ...
    const teamHtml = [
      ...
      '<tr><td style="padding:10px 0;border-bottom:1px solid #f3f4f6;color:#6b7280;font-size:14px;">Topic</td>',
      '<td style="padding:10px 0;border-bottom:1px solid #f3f4f6;font-size:14px;">' + subject + '</td></tr>',
      '</table>',
      ...
      '</div>',
      '<p style="margin-top:24px;font-size:12px;color:#9ca3af;">Reply to this email to respond to ' + name + '.</p>',
      '</div>',
    ].join("");
    ...
    const userHtml = [
      ...
      '<p style="color:#374151;line-height:1.7;margin:16px 0;">',
      "Thanks for reaching out to EnaTalk. We have received your message and will reply to ",
      ...
      'Expected response: <strong>within 24 hours</strong> (Mon-Sat, 10am-6pm IST)',
      '</p>',
      '</div>',
      '<p style="color:#6b7280;font-size:14px;line-height:1.7;">',
      'For urgent issues, reach us on WhatsApp: ',
      '<a href="https://wa.me/919062211526" style="color:#16A34A;">+91 90622 11526</a>',
      '</p>',
      '<hr style="border:none;border-top:1px solid #f3f4f6;margin:24px 0;"/>',
      '<p style="color:#9ca3af;font-size:12px;">',
      'EnaTalk - Ramkrishna Upanibesh Jadavpur, Kolkata, West Bengal 700092, India',
      '</p>',
      '</div>',
    ].join("");
